...
public class DeleteDonor extends JFrame implements ActionListener
{
      ...
      DeleteDonor()
      {
          ...
          l1 = new JLabel("Delete Donor Information");
          ...
          b1.setToolTipText("Click To Open");
          jf.add(b1);
          ...
          {//fetch
       	  ...
       	  {//delete
       	    ...
       	    else
       	    {
                 ...
                 conn = DriverManager.getConnection("jdbc:mysql://localhost/Blood_Donation","root","root1234");
       		       System.out.println("Connected to database.");
       	         ps=conn.prepareStatement("delete from donor where DId='"+t1.getText()+"' or DName='"+t2.getText()+"'");
       	         ps.executeUpdate();

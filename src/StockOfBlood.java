...
public class StockOfBlood extends JFrame implements ActionListener
{
  Font f;
  JFrame jf;
  JLabel l1,l2;
  ...
  StockOfBlood()
  {
    ...
    b1.setToolTipText("Click To Show All Blood");
    jf.add(b1);
    b1.addActionListener(this);

    b2 = new JButton("Show");
    b2.setBounds(450,300,110,35);
    b2.setToolTipText("Click To Show Details");
    jf.add(b2);
    b2.addActionListener(this);

    b3 = new JButton("Clear");
    b3.setBounds(600,300,110,35);
    ...
    if(ae.getSource()==b1)
     {//list
       ...
       try
       {
         ...
         while(rs.next())
         {
             model.insertRow(r++, new Object[]{rs.getString(2),rs.getString(8) });
         }
         conn.close();
       }
       catch(Exception e)
    ...
    if(ae.getSource()==b2)
    {
      ...
      {//fetch
         try
         {
           ...
           System.out.println(""+t1.getText()+"COUNT ARE:"+r);

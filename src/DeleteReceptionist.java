...
public class DeleteReceptionist extends JFrame implements ActionListener
{
	...
	DeleteReceptionist()
	{
		...
		l1 = new JLabel("Delete Receptionist");
		l1.setFont(new Font("Skia",Font.BOLD,25));
		l1.setForeground(Color.white);
		l1.setBounds(325,30,400,40);
		jf.add(l1);
		...
		jf.add(l3);
		 ...
		 jf.add(l6);
		  ...
		  b2.setToolTipText("Click To Delete");
		  jf.add(b2);
      ...
      b3.addActionListener(this);
		...
		jf.setTitle("Delete Receptionist");
		jf.setSize(900,700);
			 ...
			 {//delete
			 	if(((t1.getText()).equals(""))&&((t2.getText()).equals("")))
			     {
			      ...
			      try
			       {
			    Class.forName("com.mysql.jdbc.Driver");
				conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/Blood_Donation","root","root1234");
				System.out.println("Connected to database.");
			    ps=conn.prepareStatement("delete from receptionist where RId='"+t1.getText()+"' or RName='"+t2.getText()+"'");
			    ps.executeUpdate();
